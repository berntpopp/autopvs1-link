...
class TestRealWebsiteParsing:
    ...
    async def test_parse_msh6_variant_with_unmet_strength(self):
        ...
        assert variant_info.gene_url == "https://www.genenames.org/data/gene-symbol-report/#!/hgnc_id/HGNC:7329"
        ...
        assert variant_info.haploinsufficiency_url == "https://search.clinicalgenome.org/kb/genes/HGNC:7329"
        ...
        assert variant_info.external_links["gnomAD"] == "https://gnomad.broadinstitute.org/variant/2-48033984-G-GGATT"
    ...
    async def test_parse_pou3f4_variant_with_strong_strength(self):
        ...
        assert variant_info.gene_url == "https://www.genenames.org/data/gene-symbol-report/#!/hgnc_id/HGNC:9217"
        ...
        assert variant_info.haploinsufficiency_url == "https://search.clinicalgenome.org/kb/genes/HGNC:9217"
