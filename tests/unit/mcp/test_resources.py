...
async def test_capabilities_tool_and_resource_are_not_duplicates() -> None:
    ...
    assert tool_result.structured_content["success"] is True
    assert (
        tool_result.structured_content["result"]["details_resource"]
    ...
    assert detailed_resource != tool_result.structured_content["result"]
