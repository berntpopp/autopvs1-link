...
SERVER_DESCRIPTION = (
    ...
    "Error handling: error_code is one of invalid_input | not_found | "
    "ambiguous_query | upstream_unavailable | rate_limited | internal; the "
    "specific reason is in error_subcode (e.g. invalid_variant_id, "
    "requires_disambiguation, upstream_timeout). Every error envelope sets "
    "isError=true and carries suggestions[] for recovery.\n\n"
